                        ...
                        <div class="card"  style="border-color:#b30000; border-style: dashed;">
                            ...
                            <?php foreach($waktu as $a){ ?>
                                ...
                                <div align="center" class="mb-5" style="margin-top:1%">
                                    <font size= "5" style="font-family: Bookman Old Style; font-weight: bold; color: #b30000; text-decoration: underline;">Edit Data Tanggal Riset</font>
                                </div>
                                <form action="<?php echo base_url().'research/update_waktu'; ?>" method="post">
                                    <div class="form-group row">
                                        <div class="offset-2 col-8" align="center">
                                            <input id="id_waktu" name="id_waktu" readonly type="text" required value="<?php echo $a->id_waktu ?>" class="form-control here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="offset-2 col-8" align="center">
                                            <input type="date"  id="waktu" name="waktu" placeholder="waktu" required class="form-control here" rows="3" value="<?php echo $a->waktu ?>">
                                        </div>
                                    </div>
