                    ...
                    <div class="col-md-7" style="margin-top:2%">
                        <div class="card"  style="border-color:#b30000; border-style: dashed;">
                            <?php foreach($user as $a){ ?>
                                ...
                                <form action="<?php echo base_url().'sica/update'; ?>" method="post">
                                    <div class="form-group row">
                                        <div class="offset-2 col-8" align="center">
                                            <input id="username" name="username" placeholder="ID ADMINISTRATOR/CO" type="text" required value="<?php echo $a->username ?>" class="form-control here">
