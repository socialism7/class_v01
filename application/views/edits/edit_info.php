                        ...
                        <div class="card"  style="border-color:#b30000; border-style: dashed;">
                            <?php foreach($informasi as $a){ ?>
                                ...
                                <div align="center" class="mb-5" style="margin-top:1%">
                                    <font size= "5" style="font-family: Bookman Old Style; font-weight: bold; color: #b30000; text-decoration: underline;">Edit Data Informasi Riset</font>
                                </div>
                                <form action="<?php echo base_url().'research/update_informasi'; ?>" method="post">
                                    <div class="form-group row">
                                        <div class="offset-2 col-8" align="center">
                                            <input id="id_info" name="id_info" readonly type="text" required value="<?php echo $a->id_info ?>" class="form-control here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="offset-2 col-8" align="center">
                                            <textarea id="isi" name="isi" placeholder="isi" required class="form-control here" rows="3"><?php echo $a->isi ?></textarea>
                                        </div>
                                    </div>
