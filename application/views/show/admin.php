                                                    ...
                                                    foreach($user as $a){ 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                <?php echo anchor('sica/edit/'.$a->id_user,'<img src="../assets/img/up.png" title="Edit">'); ?>
                                                                <?php echo anchor('sica/delete/'.$a->id_user,'<img src="../assets/img/del.png" title="Delete">'); ?>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
