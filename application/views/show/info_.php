                        ...
                        <div class="col-md-7" style="margin-top:2%">
                            <div class="card"  style="border-color:#b30000; border-style: dashed;">
                                                    ...
                                                    foreach($informasi as $a){ 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                <?php echo anchor('research/edit_info/'.$a->id_info,'<img src="../assets/img/up.png" title="Edit">'); ?>
                                                                <?php echo anchor('research/delete_info/'.$a->id_info,'<img src="../assets/img/del.png" title="Delete">'); ?>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                ...
                                <div align="right" class="mb-3" style="margin-right:20px">
                                    <a href="<?php echo base_url().'research/add_info'; ?>">
                                    ...
                                    <a href="<?php echo base_url().'research/show_time'; ?>">
