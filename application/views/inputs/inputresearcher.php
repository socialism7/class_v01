                    ...
                    <div class="col-md-7" style="margin-top:2%">
                        <div class="card"  style="border-color:#b30000; border-style: dashed;">
                            ...
                            <div align="center" class="mb-5" style="margin-top:1%">
                                <font size= "5" style="font-family: Bookman Old Style; font-weight: bold; color: #b30000; text-decoration: underline;">Input Data Baru Peneliti</font>
                            </div>
                            <form action="<?php echo base_url().'user/add_xecution'; ?>" method="post">
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
                                        <input id="id_researcher" name="id_researcher" placeholder="ID RESEARCHER" type="text" required class="form-control here">
                                    </div>
                                    <div class="offset-2 col-8">
                                        <font style="color:#F00; font-size:13px">*<b>ID Researcher</b> akan digunakan sebagai <b>Username</b> untuk Login</font>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
                                ...
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
                                        <input id="alamat" name="alamat" placeholder="ALAMAT" type="text" required class="form-control here">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
