                    ...
                    <div class="col-md-7" style="margin-top:2%">
                        <div class="card"  style="border-color:#b30000; border-style: dashed;">
                            ...
                            <div align="center" class="mb-5" style="margin-top:1%">
                                <font size= "5" style="font-family: Bookman Old Style; font-weight: bold; color: #b30000; text-decoration: underline;">Input Data Baru Wilayah Riset</font>
                            </div>
                            <form action="<?php echo base_url().'research/add_xecution'; ?>" method="post">
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
                                        <input id="id_wilayah" name="id_wilayah" placeholder="ID WILAYAH" type="text" required class="form-control here">
                                    </div>
                                    <div class="offset-2 col-8">
                                        <font style="color:#F00; font-size:13px">*<b>ID Wilayah</b> yang dimasukan, tidak akan bisa diganti</font>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
                                        <input id="nama_desa" name="nama_desa" placeholder="NAMA DESA" type="text" required class="form-control here">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
                                        <input id="nama_kec" name="nama_kec" placeholder="NAMA KECAMATAN" type="text" required class="form-control here">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
                                        <input id="nama_kab_kot" name="nama_kab_kot" placeholder="NAMA KAB./KOTA" type="text" required class="form-control here">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
                                        <input id="nama_prov" name="nama_prov" placeholder="NAMA PROVINSI" type="text" required class="form-control here">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
