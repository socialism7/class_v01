                    ...
                    <div class="col-md-7" style="margin-top:2%">
                        <div class="card"  style="border-color:#b30000; border-style: dashed;">
                            ...
                            <div align="center" class="mb-5" style="margin-top:1%">
                                <font size= "5" style="font-family: Bookman Old Style; font-weight: bold; color: #b30000; text-decoration: underline;">Create New Information</font>
                            </div>
                            <form action="<?php echo base_url().'research/executeinfo'; ?>" method="post">
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
                                        <textarea id="isi" name="isi" placeholder="INFORMASI BARU" required class="form-control here"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="offset-2 col-8" align="center">
